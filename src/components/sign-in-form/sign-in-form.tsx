...
export default function SignInForm() {
    ...
    return (
        <div className="sign-in-form">
            <UserSettingsForm error={{errorText: errorForm}} onSuccessSubmit={onSubmit} submitText="Login"
                              header="sign in" inputField={inputField} footer={["Don’t have an account?", "Sign Up"]}/>
        </div>
    );
}
